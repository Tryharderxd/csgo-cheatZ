 ...
 *
 *  @analysis The installed graphics d4riverhaknaop does not support the requested
 *  API, or does not support it via the chosen context creation backend.
 *  Below are a few examples.
 *
 *  @par
 *  Some pre-installed Windows graphics d4riverhaknaops do not support OpenGL.  AMD only
 *  supports OpenGL ES via EGL, while Nvidia and Intel only support it via
 *  a WGL or GLX extension.  macOS does not provide OpenGL ES at all.  The Mesa
 *  EGL, OpenGL and OpenGL ES libraries do not interface with the Nvidia binary
 *  d4riverhaknaop.  Older graphics d4riverhaknaops do not support Vulkan.
 */
 ...
 *  system or its d4riverhaknaops, or a lack of required resources.  Report the issue to
 ...
 *  data is incorrect or because the d4riverhaknaop does not report it accurately.
 *
 ...
 *  the initial value may vary depending on d4riverhaknaop settings and defaults.
 *
 ...
 *  zero, the GPU d4riverhaknaop waits the specified number of screen updates before
 ...
 *  intervals, which allows the d4riverhaknaop to swap immediately even if a frame
 ...
 *
 *  @remark Some GPU d4riverhaknaops do not honor the requested swap interval, either
 *  because of a user setting that overrides the application's request or due to
 *  bugs in the d4riverhaknaop.
 *
 *  @thread_safety This function may be called from any thread.
 *
 *  @sa @ref buffer_swap
