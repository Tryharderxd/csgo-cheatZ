...
namespace offset
{
	constexpr uint64_t uworld_key = 0x8A61778;
	constexpr uint64_t uworld_state = 0x8A61740;
	...
	constexpr uint64_t actor_count = 0xA8;
	...
	constexpr uint64_t damage_handler = 0x978;
	...
	constexpr uint64_t acknowledged_pawn = 0x440;
