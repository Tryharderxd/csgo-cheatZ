// fdfddvvfd: This file contains the 'main' function. Program execution begins and ends there.
//
...
{
    std::cout << "fdafdsfudfuidshigf" << std::endl;
    std::cout << "Efi :: Samia:: Ring0" << std::endl;
    std::cout << "Last Build @ Samia :: 24-09-2021" << std::endl;
    ...
    if (driver::initialize())
    {
        ...
        {
            wchar_t VarName[] = { 'C','O','C','K','D','r','i','v','e','r','\0' };
